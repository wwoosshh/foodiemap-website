...
export const ko = {
  ...
  contactPage: {
    title: '문의하기',
    subtitle: '궁금하신 점이나 문제가 있으신가요? 언제든지 문의해주세요.',
    quickContact: '빠른 문의',
    emailContact: '이메일 문의',
    kakaoContact: '카카오톡 문의',
    emailContactDescription: '관리자 이메일로 직접 문의하기',
    kakaoContactDescription: '카카오톡 채널을 통해 문의하기',
    sendEmail: '이메일 보내기',
    openKakao: '카카오톡 열기',
    directContact: '사이트 내 문의',
    directContactDescription: '아래 양식을 작성하시면 관리자가 빠르게 확인하여 답변드리겠습니다.',
    name: '이름',
    ...
    message: '문의 내용',
    messagePlaceholder: '문의하실 내용을 자세히 작성해주세요',
    submit: '문의하기',
    sending: '전송 중...',
    successMessage: '문의가 성공적으로 전송되었습니다. 빠른 시일 내에 답변드리겠습니다.',
