...
export const ja: TranslationKeys = {
  ...
  contactPage: {
    title: 'お問い合わせ',
    subtitle: 'ご質問や問題がございますか？いつでもお問い合わせください。',
    quickContact: '簡単なお問い合わせ',
    emailContact: 'メールでお問い合わせ',
    kakaoContact: 'カカオトークでお問い合わせ',
    emailContactDescription: '管理者メールに直接お問い合わせ',
    kakaoContactDescription: 'カカオトークチャンネルでお問い合わせ',
    sendEmail: 'メールを送る',
    openKakao: 'カカオトークを開く',
    directContact: 'サイト内お問い合わせ',
    directContactDescription: '下記のフォームに記入していただければ、管理者が迅速に確認して回答いたします。',
    name: '名前',
    namePlaceholder: '名前を入力してください',
    email: 'メール',
    emailPlaceholder: '返信用メールアドレスを入力してください',
    subject: '件名',
    subjectPlaceholder: 'お問い合わせ件名を入力してください',
    message: 'お問い合わせ内容',
    messagePlaceholder: 'お問い合わせ内容を詳しく記入してください',
    submit: 'お問い合わせ',
    sending: '送信中...',
    successMessage: 'お問い合わせが正常に送信されました。できるだけ早く回答いたします。',
